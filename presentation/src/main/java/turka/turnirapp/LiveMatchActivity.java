...
public class LiveMatchActivity extends BaseActivity implements MatchView, AppBarLayout.OnOffsetChangedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLiveMatch = intent.getParcelableExtra("match");

        mScore.setText(mLiveMatch.getFirstTeamGoals() + "-" + mLiveMatch.getSecondTeamGoals());
        ...
        mTeamAName.setText(mLiveMatch.getFirstTeamName());
        mTeamBName.setText(mLiveMatch.getSecondTeamName());
        switch (mLiveMatch.getMatchStatus()){
            case 2:
                break;
            case 3:
                mTimer.setText(getString(R.string.half_time));
                break;
            case 4:
    ...
    private void initTimer(){
        ...
        if(mLiveMatch.getMatchStatus() == 1){
            mTimerSubscription = Observable.interval(1, TimeUnit.SECONDS)
                ...
                .subscribe(new Action1<Long>() {
                    ...
                    public void call(Long aLong) {
                        if(mLiveMatch.getMatchStatus() == 1){
                            String timerString = MatchTimerFormatter.getFormattedMatchTimer(mLiveMatch.getSecondHalf() != null && mLiveMatch.getSecondHalf() ? mLiveMatch.getSecondHalfStartTime() :  mLiveMatch.getStartTime() ,
                                    mLiveMatch.getSecondHalf());
    ...
    public int getMatchId() {
        return mLiveMatch.getID();
    }

    @Override
    public int getFirstTeamId(){
        return mLiveMatch.getFirstTeamID();
    }
}
