...
import turka.turnirapp.di.di.components.DaggerAuthenticationComponent;
import turka.turnirapp.mvp.presenters.LoginPresenter;
...
public class LoginActivity extends AppCompatActivity implements LoginView {
    ...
    private void attemptLogin() {
        ...
        if (TextUtils.isEmpty(password)) {
            mPasswordView.setError(getString(R.string.login_pass_required));
            focusView = mPasswordView;
            cancel = true;
        }

        if (TextUtils.isEmpty(username)) {
            mEmailView.setError(getString(R.string.login_username_required));
